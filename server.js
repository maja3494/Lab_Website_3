...
app.get('/team_stats',function(req,res)
{
  ...
  var query3 = 'SELECT COUNT(visitor_name) FROM football_games WHERE visitor_score>home_score;';
  db.any(query1)
    .then(function (games)
    {
...
app.get('/player_info',function(req, res){
  var queryPI = "SELECT id,name FROM football_players";
  db.any(queryPI)
    .then(function(p_info)
    {
...
app.get('/player_info/post',function(req, res){
  var DAid = req.query.player_choice;
  var queryPI = "SELECT * FROM football_players WHERE id ="+ DAid;
  db.any(queryPI)
    .then(function(p_info)
    {
      res.render('pages/player_info',
